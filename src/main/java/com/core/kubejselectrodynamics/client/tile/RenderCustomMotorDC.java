...
public class RenderCustomMotorDC extends RenderBase<TileCustomMotorDC.Render> {
    public RenderCustomMotorDC(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(TileCustomMotorDC.Render tile, float partialTicks, PoseStack matrix, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
