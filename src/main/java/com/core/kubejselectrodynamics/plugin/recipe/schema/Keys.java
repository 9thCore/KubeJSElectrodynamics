...
public class Keys {
    public static final RecipeKey<TinyMap<String, Either<Long, Either<InputItem, TagKey<Item>>>>> ITEM_INPUTS = new MapRecipeComponent<>(
            Components.ARRAY_KEY,
            Components.ARRAY_ITEM_ELEMENT_INPUT,
            false
    ).key("iteminputs");
    public static final RecipeKey<TinyMap<String, Either<Long, OutputItem>>> ITEM_BI = new MapRecipeComponent<>(
            Components.ARRAY_KEY,
